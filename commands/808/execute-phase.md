...
<execution_context>
@~/.claude/808/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `808-tools init execute-phase` and per-subagent `<files_to_read>` blocks.
</context>

<process>
Execute the execute-phase workflow from @~/.claude/808/workflows/execute-phase.md end-to-end.
