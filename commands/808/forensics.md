...
type: prompt
name: 808:forensics
description: Post-mortem investigation for failed 808 workflows — analyzes git history, artifacts, and state to diagnose what went wrong
...
<objective>
Investigate what went wrong during a 808 workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/808/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @~/.claude/808/workflows/forensics.md end-to-end.
</process>
