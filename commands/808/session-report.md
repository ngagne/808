...
<execution_context>
@~/.claude/808/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/808/workflows/session-report.md end-to-end.
</process>
