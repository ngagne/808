...
`/808:workstreams [subcommand] [args]`
...
### resume
Set the workstream as active and suggest `/808:resume-work --ws <name>`.

## Step 3: Display Results

Format the JSON output from 808-tools into a human-readable display.
Include the `${AGENT_808_WS}` flag in any routing suggestions.
