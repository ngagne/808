...
808's discuss-phase has two modes for gathering implementation context before planning.
...
808-tools config-set workflow.discuss_mode assumptions

# Switch back to interview mode
808-tools config-set workflow.discuss_mode discuss
```
