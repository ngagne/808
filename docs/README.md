...
Comprehensive documentation for the 808 (808) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `808-tools.cjs` programmatic API for workflows and agents |
...
- **Getting started:** [README](../README.md) → install → `/808:new-project`
- **Full workflow walkthrough:** [User Guide](USER-GUIDE.md)
- **All commands at a glance:** [Command Reference](COMMANDS.md)
- **Configuring 808:** [Configuration Reference](CONFIGURATION.md)
