...
- This section feeds directly into /808:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /808:plan-phase --gaps with root causes
...
**Creation:** When /808:verify-work starts new session
...
- `/808:verify-work {phase}` picks up from first pending/blocked test
