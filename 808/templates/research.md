...
**CRITICAL:** If CONTEXT.md exists from /808:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches 808 templates)
