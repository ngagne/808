...
**New Slash Command:**
- Primary code: `commands/808/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `808/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `808/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/808/workflows/{name}.md`

**New Reference Document:**
- Implementation: `808/references/{name}.md`
