...
Use /808:quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /808:quick instead:
  /808:quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /808:quick
- If you're unsure how to implement it, STOP and redirect to /808:quick
</guardrails>
