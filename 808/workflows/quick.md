<purpose>
Execute small, ad-hoc tasks with 808 guarantees (atomic commits, STATE.md tracking). Quick mode spawns 808-planner (quick mode) + 808-executor(s), tracks tasks in `.planning/quick/`, and updates STATE.md's "Quick Tasks Completed" table.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 808 ► QUICK TASK (DISCUSS + RESEARCH + FULL)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 808 ► QUICK TASK (DISCUSS + RESEARCH)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
INIT=$(node "$HOME/.claude/808/bin/808-tools.cjs" init quick "$DESCRIPTION")
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_PLANNER=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-planner 2>/dev/null)
AGENT_SKILLS_EXECUTOR=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-executor 2>/dev/null)
AGENT_SKILLS_CHECKER=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-checker 2>/dev/null)
AGENT_SKILLS_VERIFIER=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-verifier 2>/dev/null)
```

Parse JSON for: `planner_model`, `executor_model`, `checker_model`, `verifier_model`, `commit_docs`, `branch_name`, `quick_id`, `slug`, `date`, `timestamp`, `quick_dir`, `task_dir`, `roadmap_exists`, `planning_exists`.

**If `roadmap_exists` is false:** Error — Quick mode requires an active project with ROADMAP.md. Run `/808:new-project` first.
...
Spawn 808-executor with plan reference:
...
```bash
node "$HOME/.claude/808/bin/808-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
...
808 > QUICK TASK COMPLETE (FULL MODE)
