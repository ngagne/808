<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates 808-ui-researcher and 808-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
AGENT_SKILLS_UI=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-ui-researcher 2>/dev/null)
AGENT_SKILLS_UI_CHECKER=$(node "$HOME/.claude/808/bin/808-tools.cjs" agent-skills 808-ui-checker 2>/dev/null)
```
...
```bash
UI_RESEARCHER_MODEL=$(node "$HOME/.claude/808/bin/808-tools.cjs" resolve-model 808-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "$HOME/.claude/808/bin/808-tools.cjs" resolve-model 808-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "$HOME/.claude/808/bin/808-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /808:settings.
```
Exit workflow.
...
Recommended: run /808:discuss-phase {N} first to capture design preferences.
...
## 5. Spawn 808-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 808 ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/808-ui-researcher.md for instructions.
...
Template: ~/.claude/808/templates/UI-SPEC.md
</output>
...
Task(
  ...
  subagent_type="808-ui-researcher",
...
## 7. Spawn 808-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 808 ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/808-ui-checker.md for instructions.
...
- Re-spawn 808-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /808:ui-phase
...
```bash
node "$HOME/.claude/808/bin/808-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] 808-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] 808-ui-checker spawned with UI-SPEC.md
