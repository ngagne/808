...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /808:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/808/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/808/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/808/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/808/templates/discovery.md
...
Use ~/.claude/808/templates/discovery.md.
...
1. Discuss phase context (/808:discuss-phase [current-phase])
2. Create phase plan (/808:plan-phase [current-phase])
