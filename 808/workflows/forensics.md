...
Post-mortem investigation for failed or stuck 808 workflows. Analyzes git history,
...
3. {Recovery command if applicable — e.g., `/808:resume-work`, `/808:execute-phase N`}

---

*Report generated by `/808:forensics`. All paths redacted for portability.*
```
