...
4. If nothing found: error "No milestone found. Run /808:new-project or /808:new-milestone first."
...
```bash
808-tools.cjs commit "docs(v${VERSION}): generate milestone summary for onboarding" \
...
If the user is done:
- Suggest next steps: `/808:new-milestone`, `/808:progress`, or sharing the summary with the team

## Step 9: Update STATE.md

```bash
808-tools.cjs state record-session \
