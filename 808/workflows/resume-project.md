...
<required_reading>
@~/.claude/808/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "$HOME/.claude/808/bin/808-tools.cjs" init resume)
...
**If `planning_exists` is false:** This is a new project - route to /808:new-project
</step>
...
- This is the primary resumption source — structured data from `/808:pause-work`
...
📋 [N] pending todos — /808:check-todos to review
