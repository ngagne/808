...
const { scanForInjection, INJECTION_PATTERNS } = require('../808/bin/lib/security.cjs');
...
const ALLOWLIST = new Set([
  '808/bin/lib/security.cjs',        // The security module itself
  'hooks/808-prompt-guard.js',                  // The prompt guard hook
