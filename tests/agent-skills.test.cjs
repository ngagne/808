/**
 * 808 Tools Tests - Agent Skills Injection
 *
...
describe('agent-skills command', () => {
  ...
  test('handles multiple skill paths', () => {
    ...
    writeConfig(tmpDir, {
      agent_skills: {
        '808-executor': ['skills/skill-a', 'skills/skill-b'],
      },
    });
  ...
  test('warns for nonexistent skill path but does not error', () => {
    writeConfig(tmpDir, {
      agent_skills: {
        '808-executor': ['skills/nonexistent'],
      },
    });
...
describe('config-set agent_skills', () => {
  ...
  test('can set agent_skills via dot notation', () => {
    ...
    assert.deepStrictEqual(
      config.agent_skills['808-executor'],
      ['skills/my-skill'],
