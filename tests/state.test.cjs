...
`
  ...
  describe('--cwd override', () => {
    ...
    beforeEach(() => {
      outsideDir = fs.mkdtempSync(path.join(require('os').tmpdir(), '808-test-outside-'));
    });
...
const { stateExtractField, stateReplaceField, stateReplaceFieldWithFallback } = require('../808/bin/lib/state.cjs');
