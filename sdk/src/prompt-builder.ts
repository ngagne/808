...
/**
 * Extract the tools list from a 808-executor.md agent definition.
...
/**
 * Extract the role instructions from a 808-executor.md agent definition.
 ...
 * @param agentDef - Raw content of 808-executor.md agent definition (optional)
